        ...
        <div className="min-h-screen">
            ...
            <section className="pt-24 pb-12 px-4">
                <div className="max-w-7xl mx-auto text-center">
                    <span className="text-indigo-400 font-semibold text-sm uppercase tracking-wider">Blog</span>
                        ...
                        {blogArticles.map((article, index) => (
                            ...
                            >
                                <div className="relative h-48 -mx-6 -mt-6 mb-4 overflow-hidden">
                                    ...
                                    <span className="absolute top-4 left-4 px-3 py-1 bg-indigo-500/80 backdrop-blur-sm rounded-full text-xs font-semibold">
                                        {article.category}
                                    </span>
                                </div>
